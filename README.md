# sap-api-integrations-process-order-confirmation-reads
...
以下の項目のうち、"ConfirmationGroup" ～ "NoFurtherBusinessProcQtyIsExpd" は、/SAP_API_Output_Formatter/type.go 内 の Type Confirmation {} による出力結果です。"cursor" ～ "time"は、golang-logging-library-for-sap による 定型フォーマットの出力結果です。  

```
{
	"cursor": "/Users/latona2/bitbucket/sap-api-integrations-process-order-confirmation-reads/SAP_API_Caller/caller.go#L68",
	...
	"message": [
		{
			...
			"ConfirmationEntryDate": "2017-08-30T09:00:00+09:00",
			...
			"PostingDate": "2017-08-30T09:00:00+09:00",
			"ConfirmedExecutionStartDate": "2017-08-30T09:00:00+09:00",
			...
			"ConfirmedExecutionEndDate": "2017-08-30T09:00:00+09:00",
	...
	"time": "2022-01-28T16:29:44+09:00"
}
```
